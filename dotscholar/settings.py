# Settings for dotscholar using django_setup
...
TEMPLATES = [
    {
        ...
        "DIRS": [BASE_DIR / 'dotscholar/templates'],
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
...
AUTHENTICATION_BACKENDS = [
    ...
    'subscriptions.tiers.backend.TierPermissionBackend',   # your new logic
]
...
MEDIA_URL = '/media/'
MEDIA_ROOT = os.path.join(BASE_DIR, 'dotscholar/assets/media')
